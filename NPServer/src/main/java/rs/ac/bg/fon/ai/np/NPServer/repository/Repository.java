...
public interface Repository<T> {
	 ...
	 * Nakon toga se pomocu koncepta refleksije i metoda specificiranih u okviru GenericEntity interfejsa prolazi kroz svaki red rezultata i on se na kraju dodaje u listu rezultata.
