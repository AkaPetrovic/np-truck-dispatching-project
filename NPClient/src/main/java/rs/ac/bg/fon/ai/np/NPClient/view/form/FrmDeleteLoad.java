...
public class FrmDeleteLoad extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Delete load form");
        setPreferredSize(new java.awt.Dimension(819, 630));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {                                          
        try {
            ...
            Communication.getInstance().deleteLoad(load);

            JOptionPane.showMessageDialog(this, "Load has been deleted");
            this.dispose();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
